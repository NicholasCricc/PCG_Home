...
public class FinishingPoint : MonoBehaviour
{
    ...
    private Mesh CreateCube()
    {
        ...
        //bottom Square
        meshGenerator.CreateTriangle(bottomPoint3, bottomPoint2, bottomPoint1, 0);
        meshGenerator.CreateTriangle(bottomPoint4, bottomPoint3, bottomPoint1, 0);

        //front Square
        meshGenerator.CreateTriangle(bottomPoint1, bottomPoint2, topPoint2, 0);
        meshGenerator.CreateTriangle(bottomPoint1, topPoint2, topPoint1, 0);

        //right Side
        meshGenerator.CreateTriangle(bottomPoint4, topPoint1, topPoint4, 0);
        meshGenerator.CreateTriangle(bottomPoint4, bottomPoint1, topPoint1, 0);

        //left Side
        meshGenerator.CreateTriangle(bottomPoint2, topPoint3, topPoint2, 0);
        meshGenerator.CreateTriangle(bottomPoint2, bottomPoint3, topPoint3, 0);

        //back Sqaure
        meshGenerator.CreateTriangle(bottomPoint3, topPoint4, topPoint3, 0);
        meshGenerator.CreateTriangle(bottomPoint3, bottomPoint4, topPoint4, 0);
